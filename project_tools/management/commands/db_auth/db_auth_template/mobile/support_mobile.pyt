...
from ..authentication import AuthenticationFailed, BaseAuthentication
from .support_mobile_ali_sms_util import send_sms, SendSmsTooOften, SmsServiceIssue, SendSmsFailed
...
class MobileUserStore:
    ...
    def get_user_by_mobile(self, mobile):
        try:
            user = User.objects.get(credential='mobile_' + mobile)
        except User.DoesNotExist:
            return None
        return user


class MobileAuthLoginView(View, MobileUserStore):
...
class MobileAuthentication(BaseAuthentication, MobileUserStore):
